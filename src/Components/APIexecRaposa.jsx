    ...
    import "/src/CSS/Componente3.css";

    function APIexecRaposa() {
    function buscarRaposa() {
        let status = document.getElementById("status-raposa");
        let imagemRaposa = document.getElementById("foto-cachorro-raposa");
    ...
    function buscarCachorro() {
        let status = document.getElementById("status-raposa");
        let imagemCachorro = document.getElementById("foto-cachorro-raposa");
    ...
    return (
        ...
        <div className="imagens-container">
            <img id="foto-cachorro-raposa" alt="" className="imagem-raposa" />
